...
void FrustumClass::ConstructFrustum(float screenDepth, XMMATRIX projectionMatrix, XMMATRIX viewMatrix) {
	...
	resultPlane = XMLoadFloat4(&m_planes[0]);
	XMStoreFloat4(&m_planes[1], XMPlaneNormalize(resultPlane));
	...
	resultPlane = XMLoadFloat4(&m_planes[0]);
	XMStoreFloat4(&m_planes[2], XMPlaneNormalize(resultPlane));
	...
	resultPlane = XMLoadFloat4(&m_planes[0]);
	XMStoreFloat4(&m_planes[3], XMPlaneNormalize(resultPlane));
	...
	resultPlane = XMLoadFloat4(&m_planes[0]);
	XMStoreFloat4(&m_planes[4], XMPlaneNormalize(resultPlane));
	...
	resultPlane = XMLoadFloat4(&m_planes[0]);
	XMStoreFloat4(&m_planes[5], XMPlaneNormalize(resultPlane));
